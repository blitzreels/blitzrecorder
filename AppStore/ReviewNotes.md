...
BlitzRecorder is a Mac recording studio. It records the Mac screen, camera, microphone, and system audio, then exports the finished take. New users can complete 10 free exports. After the free exports are used, additional exports require BlitzRecorder Pro through the App Store subscription products `dev.blitzreels.blitzrecorder.pro.monthly` or `dev.blitzreels.blitzrecorder.pro.annual`.
