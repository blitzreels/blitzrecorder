# BlitzRecorder Camera iOS App Store Metadata
...
iPhone camera for Mac

## Promotional Text

Use your iPhone as a controllable camera source for BlitzRecorder on Mac with pairing, monitor preview, recording, and transfer.
...
- Local network pairing with BlitzRecorder on Mac
- 6-digit pairing code for first connection
- Live monitor preview on the Mac
- Remote camera controls for supported iPhone hardware
- Local high-quality iPhone camera recording
...
iphone camera,mac camera,remote camera,creator camera,video camera,webcam,blitzrecorder
...
BlitzRecorder Camera is a companion app for BlitzRecorder on Mac. It does not function as a standalone recorder or editor.
...
- Tracking: No
- Camera access: Used to capture the iPhone camera source selected by the user
