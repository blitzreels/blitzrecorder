...
require_contains "docs/product-model.md" "Paid tier: none"
require_contains "docs/product-model.md" "must not block access"
require_contains "Sources/BlitzRecorderApp/AccessController.swift" "var canRenderExport: Bool"
require_contains "Sources/BlitzRecorderApp/AccessController.swift" "BlitzRecorder is free and open source"
require_contains "Sources/BlitzRecorderApp/UI/BlitzReelsCreatorPage.swift" "No export limit, no account, no subscription."
require_contains "Web/blitzrecorder/lib/content.ts" "There is no Pro tier, export limit, watermark, account, or card requirement."
require_contains "AppStore/Metadata-macOS.md" "In-App Purchases"
require_contains "AppStore/Metadata-macOS.md" "None."
