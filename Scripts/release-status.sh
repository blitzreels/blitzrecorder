...
- Confirm App Store Connect subscription localization matches the expected BlitzRecorder Pro names and description
...
run_check "App Store Connect Verifier Fixtures" Scripts/test-app-store-connect-readiness.py
run_check "App Store Connect Bootstrap Fixtures" Scripts/test-app-store-connect-bootstrap.py
run_check "App Store Connect Dry Run" Scripts/app-store-connect-readiness.py --dry-run
run_check "StoreKit Local Configuration" Scripts/validate-storekit-local.sh
