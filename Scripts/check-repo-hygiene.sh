...
reject_regex 'uses: (actions/checkout@v4|actions/setup-node@v4|actions/upload-artifact@v4|actions/download-artifact@v4|ilammy/msvc-dev-cmd@v1)' "no Node 20 GitHub Actions"
...
require_literal_in_file ".github/workflows/ci.yml" "actions/checkout@v7"
...
require_literal_in_file "Apps/WindowsStudio/Sources/WindowsCapture/capture_abi.cpp" "missing microphone audio"
require_literal_in_file "Apps/WindowsStudio/Sources/WindowsCapture/capture_common.cpp" "fileSizeUtf8"
require_literal_in_file "Apps/WindowsStudio/Sources/WindowsCapture/capture_common.h" "fileSizeUtf8"
...
require_literal_in_file "Apps/WindowsStudio/Sources/WindowsCapture/capture_common.cpp" "primeMicrophoneConsent"
require_literal_in_file "Apps/WindowsStudio/Sources/WindowsCapture/win32_shell.cpp" "primeMicrophoneConsent"
require_literal_in_file "Apps/WindowsStudio/Sources/WindowsCapture/winui_shell.cpp" "primeMicrophoneConsent"
require_literal_in_file "Apps/WindowsStudio/Sources/WindowsCapture/wgc_capturer.cpp" "primeGraphicsCaptureConsent"
require_literal_in_file "Apps/WindowsStudio/Sources/WindowsCapture/win32_shell.cpp" "primeGraphicsCaptureConsent"
require_literal_in_file "Apps/WindowsStudio/Sources/WindowsCapture/winui_shell.cpp" "primeGraphicsCaptureConsent"
