...
require_file "Scripts/dmg/hide-support-files.sh"
require_file "Scripts/validate-public-dmg.sh"
require_file "Resources/dmg/background.png"
require_file "Resources/dmg/dmgly.json"
...
require_file "Scripts/check-repo-hygiene.sh"
...
require_executable "Scripts/dmg/hide-support-files.sh"
