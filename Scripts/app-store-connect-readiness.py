...
def check_local_files(root: Path) -> int:
    ...
    contains_checks = [
        ...
        ("AppStore/SubmissionChecklist.md", "AppStore/ReleaseEvidence.md"),
        ...
        ("AppStore/Metadata.md", "AppStore/ReleaseEvidence.md"),
        ...
        ("AppStore/ReleaseEvidence.md", "AppStore/ReleaseEvidence.generated.md"),
        ("AppStore/ReleaseEvidence.md", "BLITZRECORDER_ENTITLEMENT_TOKEN=TOKEN Scripts/validate-entitlement-endpoint.sh"),
        ("AppStore/ReleaseEvidence.md", "Final Decision"),
        ("AppStore/ReleaseEvidence.md", "AppStore/AppStoreConnectManualSetup.md"),
        ("AppStore/ReleaseEvidence.md", "AppStore/AppStoreQuestionnaires.md"),
        ...
        ("AppStore/AppStoreConnectManualSetup.md", "AppStore/ReleaseEvidence.md"),
        ...
        ("Scripts/update-release-evidence.py", "App Store Connect Verifier Fixtures"),
        ("Scripts/update-release-evidence.py", "App Store Connect Bootstrap Fixtures"),
        ("Scripts/update-release-evidence.py", "Landing page pricing copy"),
        ...
        ("Scripts/collect-release-evidence.sh", "AppStore/ReleaseEvidence.generated.md"),
