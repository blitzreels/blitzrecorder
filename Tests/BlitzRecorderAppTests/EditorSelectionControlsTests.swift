...
final class EditorSelectionControlsTests: XCTestCase {
    ...
    func testKeyboardModifiersLeaveSystemAndTextCommandsUntouched() {
        ...
        XCTAssertEqual(command(.init(keyCode: 24, characters: "=", modifiers: .command)), .zoomIn)
        XCTAssertEqual(command(.init(keyCode: 27, characters: "-", modifiers: .command)), .zoomOut)
    ...
    func testRangePlaybackAndZoomShortcuts() {
        ...
        XCTAssertEqual(command(.init(keyCode: 24, characters: "=", modifiers: .command)), .zoomIn)
        XCTAssertEqual(command(.init(keyCode: 24, characters: "+", modifiers: [.command, .shift])), .zoomIn)
        XCTAssertEqual(command(.init(keyCode: 69, characters: "+", modifiers: .command)), .zoomIn)
        XCTAssertEqual(command(.init(keyCode: 27, characters: "-", modifiers: .command)), .zoomOut)
        XCTAssertEqual(command(.init(keyCode: 78, characters: "-", modifiers: .command)), .zoomOut)
