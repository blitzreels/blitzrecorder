...
The script builds, signs, installs `/Applications/BlitzRecorder.app`, and launches that stable app identity. Use it for local testing instead of launching arbitrary build products because macOS privacy grants are tied to bundle identity, code signature, and app location.
