...
export const PUBLIC_DMG_NAME = "BlitzRecorder-0.1.1-2-macOS-universal.dmg";
export const PUBLIC_DMG_URL = `/downloads/${PUBLIC_DMG_NAME}`;
export const PUBLIC_CHECKSUMS_URL = "/downloads/SHA256SUMS";
...
export async function getLatestRelease(): Promise<Release | null> {
  try {
    ...
    return {
      ...
      tag: data.tag_name,
      dmgUrl: PUBLIC_DMG_URL,
      htmlUrl: PUBLIC_DMG_URL,
